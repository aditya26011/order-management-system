package com.example.order_management_system.filter;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    private HandlerExceptionResolver handlerExceptionResolver; // since this is not in dispatcher servlet global handler doesn't handle it
